...
*/
export function validate(ion, schema, schema_type, is_document) {
    ...
    const ret = wasm.validate(ptr0, len0, ptr1, len1, ptr2, len2, is_document);
...
export class SchemaValidationResult {
    ...
    */
    constructor(r, v, val, has_error, error) {
        ...
        const ptr1 = passStringToWasm0(error, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.schemavalidationresult_new(r, addHeapObject(v), ptr0, len0, has_error, ptr1, len1);
        return SchemaValidationResult.__wrap(ret);
    }
    /**
    * @returns {boolean}
    ...
    */
    violations() {
        const ret = wasm.schemavalidationresult_violations(this.ptr);
